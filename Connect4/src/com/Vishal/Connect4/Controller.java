...
public class Controller implements Initializable {
    ...
    private final Disc[][] insertedDiscsArray=new Disc[ROWS][COLUMNS]; //FOR STUCTURAL CHANGES
    @FXML
    ...
    private boolean isAllowedTOInsert=true; //Flag to same color disc
    ...
    translateTransition.setOnFinished(event -> {
        isAllowedTOInsert=true; //When disc is dropped to bottom we allow next player to move
    ...
    public void resetGame() {
        ...
        //Structurally make all element is insertedDiscArray Null
        for (Disc[] discs : insertedDiscsArray) {
            Arrays.fill(discs, null);
        }
        isPlayerOneTurn=true; //Let palyer one start the game
        playerNameLabel.setText(PLAYER_ONE);
        createPlayground(); //Prepare new fresh palyground
    }
